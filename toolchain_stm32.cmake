...
#    get_target_property(TARGET_LD_FLAGS ${TARGET} LINK_FLAGS)
#    if(TARGET_LD_FLAGS)
#        set(TARGET_LD_FLAGS "\"-T${CMAKE_CURRENT_BINARY_DIR}/${STM32_LINKER_SCRIPT}\" ${TARGET_LD_FLAGS}")
#    else()
#        set(TARGET_LD_FLAGS "\"-T${CMAKE_CURRENT_BINARY_DIR}/${STM32_LINKER_SCRIPT}\"")
#    endif()
#    set_target_property(${TARGET} PROPERTIES LINK_FLAGS ${TARGET_LD_FLAGS})
endfunction()
